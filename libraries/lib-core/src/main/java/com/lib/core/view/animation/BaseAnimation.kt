...
abstract class BaseAnimation(
    ...
    private val mOnAnimationStartEndListenerList: MutableList<OnAnimationStartEndListener> by lazy {
        ArrayList<OnAnimationStartEndListener>()
    }

    protected val mOnAnimationUpdateListenerList: MutableList<OnAnimationUpdateListener> by lazy {
