...
/**
 * This class to request the current location from user's device
 */
class MapApiClient(val context: Context, private var requestInterval: Long = 30000L,
    ...
    fun requestLastLocation(): MapApiClient {
     ...
     *@param priority
     */
    fun setPriority(priority: Int): MapApiClient {
    ...
    fun registerDataCallBack(onLocation: (location: Location) -> Unit,
                             ...
                             onError: (e: Exception) -> Unit): MapApiClient {
